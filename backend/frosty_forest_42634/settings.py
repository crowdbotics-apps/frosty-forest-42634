"""
Django settings for frosty_forest_42634 project.
...
ROOT_URLCONF = 'frosty_forest_42634.urls'
...
WSGI_APPLICATION = 'frosty_forest_42634.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_forest_42634 API",
    "DESCRIPTION": "API documentation for frosty_forest_42634 App",
    "VERSION": "v1",
}
